...
- Remote browsing: live temporary SSH listings can be navigated in the TUI; next steps are promotion/import controls for browsed directories and caching directory observations only after the user asks for a tracked root.
