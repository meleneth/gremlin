...
- Transfer planning/copying: persisted dry-run root-to-root plans, job events, CLI inspection, TUI plan browsing, streamed hash-checked local copy execution, and optional paranoid readback exist for TUI selections; next slices should add TUI review decisions, checksum collection comparisons, and resumable copy checkpoints.
